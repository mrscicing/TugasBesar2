            ...
            <div class="card-body p-0">
                <div class="container">
                        ...
                        <table >
                                ...
                                <td style="width:5% ;">:</td>
                                <td >
                                    <?php echo $dtpenyesuaian->tanggal?>
                                </td>
                                </tr>
                                <tr>
                                ...
                                <td style="width:5% ;">:</td>
                                <td >
                                    <?php echo $dtpenyesuaian->deskripsi?>
                                </td>
                                
                                </tr>
                                <tr>
                                <td style="width:12% ;" >Nilai</td>
                                <td style="width:5% ;">:</td>
                                <td >
                                    <?php echo $dtpenyesuaian->nilai?>
                                </td>
                                </tr>
                                <tr>
                      ...
                      <tr>
                        ...
                        <tbody>
                        <?php $x = 1;
                         foreach($dtnilaipenyesuaian as $key =>$value) :?>
                          <tr>
