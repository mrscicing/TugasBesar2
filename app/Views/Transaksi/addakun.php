    ...
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="container">
                    <form action="<?php echo site_url('/transaksi/save')?>" method="$_POST">
                        <?php csrf_field() ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Masukkan Keterangan Jurnal" name="ketJurnalx" required>
                        </div>
