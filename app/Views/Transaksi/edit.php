    ...
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="container">
                    <form action="<?php echo site_url('transaksi/editdata')?>" method="$_POST">
                        <?php csrf_field() ?>
                        ...
                        <input type="hidden" name="idx" value="<?php echo $dttransaksi->id_transaksi?>">

                        <div class="form-group">
                            <label for="exampleInputPassword1">Tanggal</label>
                            <input type="date" class="form-control"  placeholder="Masukkan Tanggal" name="tanggalx" required value="<?php echo $dttransaksi->tanggal ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Deskripsi</label>
                            <input type="text" class="form-control"  placeholder="Masukkan Deskripsi" name="deskripsix" required value="<?php echo $dttransaksi->deskripsi ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Keterangan Jurnal</label>
                            <input type="text" class="form-control"  placeholder="Masukkan Keterangan Jurnal" name="ketJurnalx" required value="<?php echo $dttransaksi->ketJurnal ?>">
                        </div>
