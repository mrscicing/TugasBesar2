                      ...
                      <tr>
                        ...
                        <?php $x = 1;
                         foreach($akun3 as $akn) :?>
                          ...
                          <td>
                            <a href="/akun3/edit/<?php echo $akn->id_akun3?>" class="btn btn-info">Edit</a>                          
                            <a  href="/akun3/delete/<?php echo $akn->id_akun3?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin data menghapus ini?') ">Delete</a>
                          </td>
                          </tr>
                        <?php $x ++;
                         endforeach?>
