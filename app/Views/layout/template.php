...
<head>
  ...
  <link rel="stylesheet" href="<?php base_url()?>/template/node_modules/Dist-DataTables-Responsive-Bootstrap4-master/css/responsive.bootstrap4.css">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Ari Nur Shaffan</div></a>
