...
<div class="main-content">
    <section class="section">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo site_url('neracasaldo')?>" method="$_POST">
                    <?php csrf_field()?>       
                    <div class="row g-3">
                        ...
                        <td>                <button class="btn btn-success"><a style="color:unset" href="<?php echo site_url('neracasaldo/cetak')?> " target="_BLANK">Cetak PDF</a></button></td>
