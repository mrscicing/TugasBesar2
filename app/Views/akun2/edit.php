    ...
    <section class="section">
        <div class="section-header">
           ...
           <div class="row">
              ...
              <div class="col-2">
                <button type="submit" class="btn btn-danger" name="submitx"><a class="nostyle" href="<?php  echo site_url('akun2/add') ?>">Add Data</a></button>
                <button type="submit" class="btn btn-danger" name="submitx"><a class="nostyle" href="<?php  echo site_url('akun2/index') ?>">Back</a></button>
              </div>
           </div>
           </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="container">
                    <form action="<?php echo site_url('akun2/editdata')?>" method="$_POST">
                     
                            <input type="hidden" value="<?php echo $id ?>" name="id_akun">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"placeholder="Masukkan Kode" name="kode_akun2">
                            <?php   if(session()->getFlashdata('notif')): ?>
                                <div class="notifs" role="alert"> 
                                    <div class="row">
                                        <div class="col-11">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="Masukkan Nama" name="nama_akun2">
                        </div>
